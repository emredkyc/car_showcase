<div align="center">
  <br />
    <a href="https://carhub-dev.vercel.app" target="_blank">
      <img src="https://i.ibb.co/SPbHDch/car-showcase.png" alt="Project Banner">
    </a>
  <br />
...
```bash
git clone https://github.com/emredkyc/car_showcase.git
cd car_showcase
```
...
Replace the placeholder values with your actual credentials. You can obtain these credentials by signing up on the corresponding websites from [Rapid API](https://rapidapi.com/apininjas/api/cars-by-api-ninjas?utm_source=youtube.com%2FJavaScriptMastery&utm_medium=referral&utm_campaign=DevRel). [Imagin Cars](https://www.imagin.studio/solutions/api)
...
Assets used in the project are [here](https://drive.google.com/file/d/1-nV8EMWnPkcTjFQjTRrmRHxnB_I9KTOA/view)
